...
padded_image = np.pad(image, pad_width=((image_height_pad, image_height_pad + image_height_pad_extra), (image_width_pad, image_width_pad + image_width_pad_extra)), mode='constant', constant_values=np.nan)
...
# TODO show NCC next to animation
