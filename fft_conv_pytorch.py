...
### Code taken from https://github.com/fkodom/fft-conv-pytorch
### Downloaded instead of using as a package as I had to edit
...
def complex_matmul(a: Tensor, b: Tensor, groups: int = 1) -> Tensor:
    ...
    c = torch.zeros(real.shape, dtype=a.dtype, device=a.device)
...
def fft_conv(
    ...
    signal_padding = [r(p) for p in padding_[::-1] for r in (ceil, floor)]
    ...
    kernel_fr.imag *= torch.tensor(-1, dtype=signal.dtype)
